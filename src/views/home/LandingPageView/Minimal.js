...
const CARDS = [
  ...
  },
  {
    ...
    description:
      'Make appointments with your preferred labs on a date and time that works for you best.'
  },
  {
    icon: '/static/icons/authentic.svg',
    title: 'Verifiable Results',
    description:
      'The authenticity of your test results can be easily verified on our platform.'
  },
  {
    icon: '/static/icons/qr-code-scan.svg',
    title: 'Sharable Results',
    description:
      'Easily share test results to third parties, in document format and mobile readable QR Codes.'
  },
  {
    icon: '/static/icons/recurring.svg',
    title: 'Manage Recurring Tests',
    description:
      'We also help you manage recurring tests, ensuring that you do not miss any important test updates.'
  },
  {
  ...
  },
  {
    ...
    description:
      'We can also send you a sample collection kit so that you can provide test samples wherever you are.'
  }
];
