...
const CARDS = [
  ...
  },
  {
    ...
    title: '2',
    description:
      'Schedule an appointment to visit a lab or to receive the sample collection kit.'
  },
  {
    icon: '/static/images/Payment.svg',
    title: '3',
    description:
      'Pay for test online, directly via bank transfer or using your Debit/Credit Cards.'
  },
  {
    icon: '/static/images/Message.svg',
    title: '4',
    description:
      'Receive test results as SMS, Email or other shareable document format.'
  }
];
