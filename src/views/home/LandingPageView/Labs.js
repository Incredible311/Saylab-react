            ...
            <div className={classes.content}>
              ...
              <MotionInView variants={textAnimate}>
                <Typography sx={{ color: 'text.secondary' }}>
                  As a medical laboratory, you can work with us to increase your
                  revenue, grow your customer base, and be a part of the future
                  of medical testing in your community. While our focus is on
                  providing great service to our customers, we also recognize
                  fact that fruitful partnerships with medical laboratories in
